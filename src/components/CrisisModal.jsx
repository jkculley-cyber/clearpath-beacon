    ...
    <>
      ...
      {triggerKey === 'abuse' && (
        <div style={dfpsCallout}>
          ...
          <br />
          You are required to report personally <strong>within 24 hours</strong> to DFPS or a law enforcement agency — many districts require both (TFC §261.101, as amended by SB 571, 2025). Per TEA guidance, a school district police department does <strong>not</strong> count — telling your SRO does not discharge the duty. Beacon documents that you reported, but cannot make the calls for you.
        </div>
      )}
  ...
  return (
    <>
      ...
      {triggerKey === 'abuse' && stepIdx === 0 && (
        <div style={dfpsCallout}>
          <strong>DFPS hotline:</strong> 1-800-252-5400 — make this call personally before completing the workflow. If your district also requires a law enforcement report, only DPS, municipal police, a sheriff, or a constable count — a district PD/SRO does not. Reports are due within <strong>24 hours</strong> of first suspecting abuse or neglect.
        </div>
      )}
